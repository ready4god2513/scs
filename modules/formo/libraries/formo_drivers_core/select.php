...
class Formo_select_Driver extends Formo_Element {
	...
	{
        // A blank is allowed only if the item is not required.
        ...
        // Even if the field is optional, only pass a blank as valid if it appears
        // in the data array or has been added as a 'blank'.
