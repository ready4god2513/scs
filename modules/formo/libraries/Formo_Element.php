...
class Formo_Element_Core {
	...
	// For group items only	
	protected $elements = array();
	public $group_label;
	public $group_open;
	public $group_close;
	public $element_label_place = 'close';
	...
	// generates the appropriate id for a form element
	protected function make_id()
	{
		$this->id = ($this->formo_name == 'formo') ? $this->name : $this->formo_name.'_'.$this->name;
	}
	...
	// make sure the posted value was one of the choices
